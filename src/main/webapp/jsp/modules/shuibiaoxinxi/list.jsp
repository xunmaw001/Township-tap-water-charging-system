                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                        ...
                                        <label>
                                            <input type="text" id="sbnameSearch" class="form-control form-control-sm"
                            ...
                            <table id="tableId" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <th onclick="sort('sbname')">水表信息</th>
...
<script>
    ...
    function search() {
        ...
        if ($('#sbnameSearch').val() != null && $('sbnameSearch').val() != '') {
            searchForm.sbname = $('#sbnameSearch').val();
    ...
    function getDataList() {
        http("shuibiaoxinxi/page", "GET", {
            page: pageIndex,
            limit: pageSize,
            sort: sortColumn,
            order: sortOrder,
                    sbname: searchForm.sbname,
    }, (res) => {
            if(res.code == 0
            )
            {
    ...
    function setDataRow(item, number) {
        ...
        var sbnameCell = document.createElement('td');
        sbnameCell.innerHTML = item.sbname;
        row.appendChild(sbnameCell);
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            ...
            httpJson("shuibiaoxinxi/delete", "POST", paramArray, (res) => {
                if(res.code == 0
        )
            {
                getDataList();
    ...
    function getSum(colName) {
        http("shuibiaoxinxi" + colName, "GET", {
    ...
    function crossTable(id, crossTableName) {
        ...
        window.sessionStorage.setItem('crossTableName', "shuibiaoxinxi");
