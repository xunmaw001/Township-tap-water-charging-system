                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="meterdata" name="meterdata" class="form-control"
                                               v-model="ruleForm.meterdata" readonly>
                                    </div>
                                <div class="form-group col-md-6">
                                    <label>
                                        使用水表
                                ...
                                <div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="lastmeter" name="lastmeter" class="form-control"
                                               v-model="ruleForm.lastmeter" readonly>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>用水量</label>

                                        <input id="useyield" name="useyield" class="form-control"
                                               v-model="ruleForm.useyield" readonly>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>价格</label>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="noticeTime" name="noticeTime" class="form-control"
                                               v-model="ruleForm.noticeTime" readonly>
                                    </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "shuifeixinxi/info/" + id,
        ...
        for (var i = 0; i < yhTypesOptions.length; i++) {
            if(yhTypesOptions[i].id == ruleForm.yhTypes){//下拉框value对比,如果一致就赋值汉字
                var yhTypesSelect = document.getElementById("yhTypesSelect");
                    yhTypesSelect.value = yhTypesOptions[i].name;
            }
        }
        for (var i = 0; i < sbTypesOptions.length; i++) {
            if(sbTypesOptions[i].id == ruleForm.sbTypes){//下拉框value对比,如果一致就赋值汉字
                var sbTypesSelect = document.getElementById("sbTypesSelect");
                    sbTypesSelect.value = sbTypesOptions[i].sbname;
            }
        }
    }
