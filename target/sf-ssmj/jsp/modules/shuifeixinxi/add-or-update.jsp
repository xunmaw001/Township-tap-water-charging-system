                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="meterdata" name="meterdata" class="form-control"
                                           onchange="meterdataChickValue(this)"  placeholder="抄表数据">
                                </div>
                                <div class="form-group col-md-6">
                                    <label>日期</label>
                                    <input id="moneyTime" name="moneyTime" type="month"  class="form-control"
                                           placeholder="日期">
                                </div>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("shuifeixinxi/" + urlParam, "POST", data, (res) => {
                if(res.code == 0
        )
            {
    ...
    //搜素输入检查
            ...
            function meterdataChickValue(e){
                var this_val = e.value || 0;
                var reg=/^[0-9]*$/;
                if(!reg.test(this_val)){
                    e.value = "";
            ...
            function lastmeterChickValue(e){
                var this_val = e.value || 0;
                var reg=/^[0-9]*$/;
                if(!reg.test(this_val)){
                    e.value = "";
    ...
    function getDetails() {
        ...
        if (id != null && id != "" && id != "null") {
            updateId = id;
            window.sessionStorage.removeItem('updateId');
            http("shuifeixinxi/info/" + id, "GET", {}, (res) => {
                if(res.code == 0
        )
            {
                ruleForm = res.data
    ...
    function dataBind() {
        ...
        $("#meterdata").val(ruleForm.meterdata);
        $("#moneyTime").val(ruleForm.moneyTime);
        $("#noticeContent").val(ruleForm.noticeContent);
        $("#lastmeter").val(ruleForm.lastmeter);
        $("#useyield").val(ruleForm.useyield);
